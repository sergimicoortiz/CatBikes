    ...
    const UserOrButtons = isAuth ? (
        <>
            ...
            <li className={path === "profile" ? "active" : ""}>
                <a onClick={() => redirects.profile()}>{user.username}</a>
            </li>
        ...
        >
            <a onClick={() => redirects.login()}>Login</a>
        </li>
    );
    ...
    const dashboardButton = isAdmin ? (
        <>
            <li className={path === "dashboard" ? "active" : ""}>
                <a onClick={() => redirects.dashboard()}>Dashboard</a>
            </li>
            ...
            <li onClick={() => redirects.incidents()}>
                ...
                <span className="-count">{countAdmin.length}</span>
            </li>
        </>
    ) : (
        ""
